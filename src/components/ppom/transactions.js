...
const buttonConfigs = {
  ...
  benignAaveBorrow: {
    ...
    onClick: () => transactionUtils.sendTransaction({
      to: transactionUtils.getContractAddress(globalContext.networkName, 'malicious'),
      data: '',
      value: '0x0',
    }),
  },
  benignAaveWithdraw: {
  ...
  benignAavePermitStaking: {
    ...
    onClick: () => transactionUtils.signTypedData(`{ "types": { "EIP712Domain": [ { "name": "name", "type": "string" }, { "name": "version", "type": "string" }, { "name": "chainId", "type": "uint256" }, { "name": "verifyingContract", "type": "address" } ], "Permit": [ { "name": "owner", "type": "address" }, { "name": "spender", "type": "address" }, { "name": "value", "type": "uint256" }, { "name": "nonce", "type": "uint256" }, { "name": "deadline", "type": "uint256" } ] }, "primaryType": "Permit", "domain": { "name": "Aave token V3", "version": "2", "chainId": "1", "verifyingContract": "0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9" }, "message": { "owner": "0x6535d5f76f021fe65e2ac73d086df4b4bd7ee5d9", "spender": "0x4da27a545c0c5b758a6ba100e3a049001de870f5", "value": "100000000000000000", "nonce": "0", "deadline": "1732787332" } }`),
  },
  benignAaveStaking: {
...
export function ppomMaliciousTransactionsAndSignatures(parentContainer) {
  ...
  const sections = [
    {
      title: 'Transactions',
      buttons: ['maliciousRawEth', 'mintSepoliaERC20', 'maliciousERC20Transfer', 'maliciousApproval', 'maliciousContractInteraction', 'maliciousSetApprovalForAll']
    },
    {
      title: 'Signatures',
    ...
    },
    {
      ...
      buttons: ['malicious1InchOrder', 'maliciousSafeMessage']
    },
    {
      title: 'AAVE',
      buttons: ['benignAaveSupply', 'benignAaveBorrow', 'benignAaveWithdraw', 'benignAavePermitStaking', 'benignAaveStaking']
    }
  ];
